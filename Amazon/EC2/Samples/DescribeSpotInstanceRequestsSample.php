 ...
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_EC2_Model_DescribeSpotInstanceRequestsRequest
...
/**
  ...
  * @param mixed $request Amazon_EC2_Model_DescribeSpotInstanceRequests or array of parameters
  */
  function invokeDescribeSpotInstanceRequests(Amazon_EC2_Interface $service, $request) 
  {
      try {
              $response = $service->describeSpotInstanceRequests($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        DescribeSpotInstanceRequestsResponse\n");
                ...
                if ($response->isSetDescribeSpotInstanceRequestsResult()) { 
                    echo("            DescribeSpotInstanceRequestsResult\n");
                    $describeSpotInstanceRequestsResult = $response->getDescribeSpotInstanceRequestsResult();
                    $spotInstanceRequestList = $describeSpotInstanceRequestsResult->getSpotInstanceRequest();
