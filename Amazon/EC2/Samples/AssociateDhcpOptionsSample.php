 ...
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_EC2_Model_AssociateDhcpOptionsRequest
...
/**
  ...
  * @param mixed $request Amazon_EC2_Model_AssociateDhcpOptions or array of parameters
  */
  function invokeAssociateDhcpOptions(Amazon_EC2_Interface $service, $request) 
  {
      try {
              $response = $service->associateDhcpOptions($request);
