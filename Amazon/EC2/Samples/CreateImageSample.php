 ...
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_EC2_Model_CreateImageRequest
...
/**
  ...
  * @param mixed $request Amazon_EC2_Model_CreateImage or array of parameters
  */
  function invokeCreateImage(Amazon_EC2_Interface $service, $request) 
  {
      try {
              $response = $service->createImage($request);
                ...
                if ($response->isSetCreateImageResult()) { 
                    ...
                    $createImageResult = $response->getCreateImageResult();
